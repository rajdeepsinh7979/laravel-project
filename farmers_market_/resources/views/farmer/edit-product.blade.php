...
<head>
    ...
    <title>Edit Product - Farmer Panel</title>
    <!-- Bootstrap CSS -->
...
<body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">🌱 Farmer Panel</a>
    </nav>
            ...
            <nav class="col-md-2 d-none d-md-block bg-light sidebar">
                <div class="sidebar-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('farmer.myProducts') }}">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('farmer.updateProduct', $product->ProductID) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="Category" name="Category" required>
                                            ...
                                            <option {{ $product->Category == 'Grains' ? 'selected' : '' }}>Grains</option>
                                            <option {{ $product->Category == 'Dairy' ? 'selected' : '' }}>Dairy</option>
                                    ...
                                    <div class="form-group">
                                        <label for="Quantity">Quantity (kg/ltr/pcs)</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if($product->Image)
                                            <small class="form-text text-muted">Current image: <a href="{{ asset('storage/' . $product->Image) }}" target="_blank">View</a></small>
                                        @endif
                                    </div>
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save"></i> Update Product
                                    </button>
                                    <a href="{{ route('farmer.myProducts') }}" class="btn btn-secondary ml-2">
