...
<title>Edit Profile - Farmer's Market</title>
...
<div class="container-fluid" style="margin-left: 250px; padding: 20px;">
  <div class="row">
    <div class="col-12">
      <h2 class="text-success fw-bold mb-4"><i class="bi bi-pencil-square"></i> Edit Profile</h2>
      ...
      <div class="profile-card">
        ...
        <form method="POST" action="{{ route('buyer.updateProfile') }}">
          ...
          <div class="text-center">
            ...
            <a href="{{ route('buyer.profile') }}" class="btn btn-secondary btn-lg ms-2">
