...
<title>Farmer's Market - My Orders</title>
...
<div class="sidebar" id="sidebar">
  ...
  <ul class="sidebar-menu">
    ...
    <li class="active"><a href="{{ route('buyer.orders') }}"><i class="bi bi-receipt"></i> My Orders</a></li>
...
<div class="container-fluid" style="margin-left: 250px; padding: 20px;">
  <div class="row">
    <div class="col-12">
      <h2 class="text-success fw-bold mb-4"><i class="bi bi-receipt"></i> My Orders</h2>
          ...
          <div class="order-card">
            <div class="row">
              <div class="col-md-8">
                ...
                <p class="mb-1"><strong>Date:</strong> {{ $order->OrderDate->format('d M Y, H:i') }}</p>
                <p class="mb-1"><strong>Delivery Address:</strong> {{ $order->DeliveryAddress }}, {{ $order->City }}, {{ $order->Pincode }}</p>
                <p class="mb-0"><strong>Total:</strong> ₹{{ number_format($order->TotalAmount) }}</p>
              </div>
              <div class="col-md-4 text-end">
                ...
                <br>
                <button class="btn btn-outline-success btn-sm mt-2" data-bs-toggle="collapse" data-bs-target="#orderDetails{{ $order->OrderID }}">
                  View Details
                </button>
              </div>
            </div>
            <div class="collapse mt-3" id="orderDetails{{ $order->OrderID }}">
              <hr>
              <h6>Order Items:</h6>
      ...
      @else
        <div class="text-center py-5">
          <i class="bi bi-receipt-x" style="font-size: 4rem; color: #ccc;"></i>
